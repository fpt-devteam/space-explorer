...
public class GameManager : MonoBehaviour
{
  ...
  public void EndGame()
  {
    ...
    if (ScoreManager.Instance != null)
    {
      ...
      LeaderboardManager.Instance?.AddScore(new LeaderboardEntry
      {
        score = finalScore,
        playerName = PlayerManager.Instance.playerData.playerName,
        playerId = PlayerManager.Instance.playerData.playerId
      });
